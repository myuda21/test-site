                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 text-center md:text-left gap-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><a href="/military-discount" className="hover:underline">Military Discount</a></li>
                                <li><a href="/promotionsV2" className="hover:underline">Promotions</a></li>
                                <li><a href="/product-financing" className="hover:underline">Financing</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mb-1"><a href="#" className="hover:underline">Rawamangun</a></p>
                            <p><a href="#" className="hover:underline">Jakarta, Indonesia</a></p>
